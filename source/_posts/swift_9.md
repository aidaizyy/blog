...
本篇介绍Swift的基础知识：自动引用计数（_automatic reference counting_）的工作机制，循环强引用的解决方案。

<!--more-->
**Title: [Swift基础入门(9)：自动引用计数](https://aidaizyy.github.io/swift_9)**
